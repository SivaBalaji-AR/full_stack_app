...
export default function SignupPage() {
  ...
  const handleSignUp = async () => {
    ...
    if(!drivingLicense || !vehicleNumber || !vehicleRC) {
    alert("Please fill all the worker details");
    return;
    }
    const payload: any = {
      name,
    ...
    try {
      const response = await fetch("/partner/api/signup", {
        method: "POST",
        headers: {
          ...
          <form>
            <div className="grid w-full items-center gap-4">
              ...
              <div className="flex flex-col space-y-1.5">
                ...
                <div className="flex flex-col space-y-1.5">
                <Label htmlFor="vehicle_rc">Vehicle RC (Details)</Label>
                <Input 
                    id="vehicle_rc" 
                    placeholder="Vehicle RC book details" 
                    value = {vehicleRC}
